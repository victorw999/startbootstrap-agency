...
<body id="page-top">
  ...
  <header class="masthead">
    ...
    <svg id="el_HvTVi4AM_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 100">
      ...
      @-webkit-keyframes kf_el_RYIHLjV08F_an_K2Mdcg9Yg {
        0% {
          -webkit-transform: translate(167.22894287109375px, 55.9139518737793px) translate(-167.22894287109375px, -55.9139518737793px) translate(0px, -4px);
          transform: translate(167.22894287109375px, 55.9139518737793px) translate(-167.22894287109375px, -55.9139518737793px) translate(0px, -4px);
        }

        25% {
          -webkit-transform: translate(167.22894287109375px, 55.9139518737793px) translate(-167.22894287109375px, -55.9139518737793px) translate(0px, -10px);
          transform: translate(167.22894287109375px, 55.9139518737793px) translate(-167.22894287109375px, -55.9139518737793px) translate(0px, -10px);
        }

        50% {
          -webkit-transform: translate(167.22894287109375px, 55.9139518737793px) translate(-167.22894287109375px, -55.9139518737793px) translate(0px, -3px);
          transform: translate(167.22894287109375px, 55.9139518737793px) translate(-167.22894287109375px, -55.9139518737793px) translate(0px, -3px);
        }
      ...
      @-webkit-keyframes kf_el_RYIHLjV08F_an_Ns_u82A4Y {
        0% {
          -webkit-transform: translate(167.22894287109375px, 55.9139518737793px) rotate(0deg) translate(-167.22894287109375px, -55.9139518737793px);
          transform: translate(167.22894287109375px, 55.9139518737793px) rotate(0deg) translate(-167.22894287109375px, -55.9139518737793px);
        }

        25% {
          -webkit-transform: translate(167.22894287109375px, 55.9139518737793px) rotate(10deg) translate(-167.22894287109375px, -55.9139518737793px);
          transform: translate(167.22894287109375px, 55.9139518737793px) rotate(10deg) translate(-167.22894287109375px, -55.9139518737793px);
        }
      ...
      @-webkit-keyframes kf_el_1atp179PmX_an_c-te_2NWG {
        0% {
          -webkit-transform: translate(-8.75px, 73.98625946044922px) translate(8.75px, -73.98625946044922px) translate(0px, 0px);
          transform: translate(-8.75px, 73.98625946044922px) translate(8.75px, -73.98625946044922px) translate(0px, 0px);
        }

        50% {
          -webkit-transform: translate(-8.75px, 73.98625946044922px) translate(8.75px, -73.98625946044922px) translate(-20px, 0px);
          transform: translate(-8.75px, 73.98625946044922px) translate(8.75px, -73.98625946044922px) translate(-20px, 0px);
        }
      ...
      @-webkit-keyframes kf_el_O23WCMreW0W_an_fpHqPBGsm {
        0% {
          -webkit-transform: translate(-22.25px, 74.07733917236328px) translate(22.25px, -74.07733917236328px) translate(0px, 0px);
          transform: translate(-22.25px, 74.07733917236328px) translate(22.25px, -74.07733917236328px) translate(0px, 0px);
        }

        50% {
          -webkit-transform: translate(-22.25px, 74.07733917236328px) translate(22.25px, -74.07733917236328px) translate(18px, 0px);
          transform: translate(-22.25px, 74.07733917236328px) translate(22.25px, -74.07733917236328px) translate(18px, 0px);
        }
    ...
    <div class="container">
      <div class="intro-text">
        ...
        <div class="intro-heading text-uppercase">AKWA 20.05.07 deploy bluehost</div>
  ...
  <!-- email animation ref: https://bit.ly/2Yo3KxP -->
  <!--
  <section id="email-me">
    <div class="container">
      <div class="row">
